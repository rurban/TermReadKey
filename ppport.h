...
----------------------------------------------------------------------
    ...
    ppport.h -- Perl/Pollution/Portability Version 3.37_04

    Automatically created by Devel::PPPort running under perl 5.027003.
...
same function or variable in your project.
    ...
    gv_init_pv()              NEED_gv_init_pv              NEED_gv_init_pv_GLOBAL
    gv_init_pvn()             NEED_gv_init_pvn             NEED_gv_init_pvn_GLOBAL
    gv_init_sv()              NEED_gv_init_sv              NEED_gv_init_sv_GLOBAL
...
gv_init_pv|5.015004||p
gv_init_svtype|||
gv_init_sv|5.015004||p
gv_init|||
gv_is_in_main|||
gv_magicalize_isa|||
gv_magicalize|||
...
valid_utf8_to_uvchr||5.015009|n
validate_suid|||
varname|||
vcmp||5.009000|
vcroak||5.006000|
...
# define PL_in_my_class    D_PPP_my_PL_parser_var(in_my_class)
# define PL_in_my_pod      D_PPP_my_PL_parser_var(in_my_pod)
...
#ifndef gv_fetchpvn
#  define gv_fetchpvn(name, len, flags, svt) gv_fetchpvn_flags(name, len, flags, svt)
#endif

#ifndef gv_fetchsv
#  define gv_fetchsv(name, flags, svt)   gv_fetchpvn_flags(SvPV_nolen_const(name), SvCUR(name), flags, svt)
#endif
#ifndef gv_fetchmethod_flags
#  define gv_fetchmethod_flags(stash,name,flags) gv_fetchmethod_pv_flags(stash, name, flags)
#endif

#if !defined(gv_init_pvn)
#if defined(NEED_gv_init_pvn)
static SV * DPPP_(my_gv_init_pvn)(GV *gv, HV *stash, const char *name, STRLEN len, U32 flags);
static
#else
extern SV * DPPP_(my_gv_init_pvn)(GV *gv, HV *stash, const char *name, STRLEN len, U32 flags);
#endif

#ifdef gv_init_pvn
#  undef gv_init_pvn
#endif
#define gv_init_pvn(a,b,c,d,e) DPPP_(my_gv_init_pvn)(aTHX_ a,b,c,d,e)
#define Perl_gv_init_pvn DPPP_(my_gv_init_pvn)

#if defined(NEED_gv_init_pvn) || defined(NEED_gv_init_pvn_GLOBAL)
SV *
DPPP_(my_gv_init_pvn)(GV *gv, HV *stash, const char *name, STRLEN len, U32 flags) {
...
#if defined(NEED_gv_init_pv)
static SV * DPPP_(my_gv_init_pv)(GV *gv, HV *stash, char *name, U32 flags);
static
#else
extern SV * DPPP_(my_gv_init_pv)(GV *gv, HV *stash, char *name, U32 flags);
#endif

#ifdef gv_init_pv
#  undef gv_init_pv
#endif
#define gv_init_pv(a,b,c,d) DPPP_(my_gv_init_pv)(aTHX_ a,b,c,d)
#define Perl_gv_init_pv DPPP_(my_gv_init_pv)

#if defined(NEED_gv_init_pv) || defined(NEED_gv_init_pv_GLOBAL)
SV *
DPPP_(my_gv_init_pv)(GV *gv, HV *stash, char *name, U32 flags) {
   if (SvUTF8(namesv))
       flags |= SVf_UTF8;
...
#if defined(NEED_gv_init_sv)
static SV * DPPP_(my_gv_init_sv)(GV *gv, HV *stash, SV* namesv, U32 flags);
static
#else
extern SV * DPPP_(my_gv_init_sv)(GV *gv, HV *stash, SV* namesv, U32 flags);
#endif

#ifdef gv_init_sv
#  undef gv_init_sv
#endif
#define gv_init_sv(a,b,c,d) DPPP_(my_gv_init_sv)(aTHX_ a,b,c,d)
#define Perl_gv_init_sv DPPP_(my_gv_init_sv)

#if defined(NEED_gv_init_sv) || defined(NEED_gv_init_sv_GLOBAL)
SV *
DPPP_(my_gv_init_sv)(GV *gv, HV *stash, SV* namesv, U32 flags) {
   char *namepv;
   STRLEN namelen;
